...
export class CreateClienteComponent implements OnInit {
  ...
  isLoading$: any;
  @Output() ClienteC: EventEmitter<Cliente> = new EventEmitter;
  ...
  ngOnInit(): void {
    ...
    this.cliente.empresa_id = this.user.empresa_id;
    this.cliente.sede_id = this.user.sede_id ? Number(this.user.sede_id) : 9999999;
    this.cliente.departamento_id = this.user.departamento_id ? Number(this.user.departamento_id) : 9999999;
    this.cliente.municipio_id = this.user.municipio_id ? Number(this.user.municipio_id) : 9999999;
  }
  ...
  store() {
    ...
    this.clienteService.registrar(this.cliente).subscribe((resp) => {
      if (resp.message === 403) {
        ...
        this.ClienteC.emit(resp.cliente);
        this.modal.close();
      }
    });
  }
